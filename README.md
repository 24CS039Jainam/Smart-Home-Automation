...
The ESP32 connects to the local Wi-Fi network on startup.

Once connected, it launches a web server that listens for commands.
...
/status returns a JSON showing current mode and state of all devices.
